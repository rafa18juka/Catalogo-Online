...
import { auroraCoverImages } from './assets'
import { readAuroraTokens } from './tokens'
import type { AuroraRendererProps, CatalogCoverContent } from './types'
...
export function AuroraRenderer({
  ...
  const { primary, secondary, background, paper, priceColor } =
    readAuroraTokens(design)
...
function AuroraCoverPage({
  ...
  return (
    ...
    >
      ...
      >
        <img
          alt={auroraCoverImages[0].alt}
          className="h-full w-full scale-110 object-cover"
          src={auroraCoverImages[0].src}
        />
      </figure>
      ...
      >
        <img
          alt={auroraCoverImages[1].alt}
          className="h-full w-full scale-110 object-cover"
          src={auroraCoverImages[1].src}
        />
      </figure>
      ...
      >
        <img
          alt={auroraCoverImages[2].alt}
          className="h-full w-full scale-105 object-cover"
          src={auroraCoverImages[2].src}
        />
      </figure>
              ...
              {column.map((collection, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1 px-3 text-sm font-black text-slate-900">
  ...
  return (
    ...
    >
      <div className="absolute right-[8%] top-0 z-20">
        <a aria-label="Voltar para o indice" href={`#${getSummaryAnchorId()}`}>
          <AuroraCategoryBadge
            collection={collection}
