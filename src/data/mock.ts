...
export const catalogDesignPresets: CatalogDesignPreset[] = [
  ...
  {
    id: 'brown-beige-modern',
    templateId: 'brown_beige_modern_01',
    packageVersion: '1.0.0',
    sourceType: 'manual',
    name: 'Brown Beige Modern',
    status: 'Publicado',
    audience: 'Casa, decoracao e linhas editoriais',
    description:
      'Modelo editorial em bege, marrom e azul profundo, inspirado no flyer criado no Canva.',
    coverStyle: 'Capa com imagem grande, destaques laterais e marca da empresa',
    gridStyle: 'Abertura de colecao e grade compacta com ate 8 produtos',
    primaryColor: '#CF874F',
    accentColor: '#01385E',
    backgroundColor: '#FDF8F1',
    surfaceColor: '#EEE1D1',
    textColor: '#2D2B32',
    previewImage: '/design-previews/brown-beige-modern.svg',
    previewKind: 'svg',
    supportsFields: defaultProductDisplayOptions,
    ...
    configJson: {
      componentKey: 'BrownBeigeModernCatalog',
      defaultTokens: {
        primaryColor: '#CF874F',
        secondaryColor: '#01385E',
        backgroundColor: '#FDF8F1',
        paperColor: '#EEE1D1',
        textColor: '#2D2B32',
        priceColor: '#FFFFFF',
